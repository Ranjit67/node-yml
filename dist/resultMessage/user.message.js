...
var userMessage = {
    error: {
        ...
        currentlyRegistered: "You are already registered, Please check your email and set your password",
        notUpdatedBlockOrUnblock: "User is verified so you can't block or active the users.",
        ...
        forgetPasswordNot: "Your account is not verified, please verify your account.",
        forgetPasswordLinkTimeHave: "Your password set link sent to your email, please check your email.",
    },
    success: {
        ...
        mailVerification: "User is created successfully. Email send to user mail for verification.",
