...
var emailTokenMessage = {
    error: {
        allField: "All field is required",
        password: "Password length must be grater than 4.",
        userNotFound: "User is not found.",
        tokenExpired: "Your password has already set, Your can't change password in same link.",
    ...
    success: {
        ...
        passwordUpdateSuccess: "Password is updated successfully. Wait for admin approval.",
    },
};
exports.default = emailTokenMessage;
//# sourceMappingURL=emailToken.message.js.map