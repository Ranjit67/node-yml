...
var requestMessage = {
    error: {
        ...
        yourRequestPending: "Your request is already pending. Wait for the Artist actions.",
        yourRequestAccept: "Your request is already manage this artist, You can not send request again.",
        ...
        managerRemovePending: "Your manager remove request is pending wait for the artist action.",
    },
    success: {
